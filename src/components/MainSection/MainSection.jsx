...
export const MainSection = () => {
  ...
  return (
    <div className="w-full min-h-screen h-full flex flex-col xl:justify-between xl:flex-row">
      <div className="w-full relative sm:static xl:w-1/2 xl:min-h-screen flex flex-col sm:gap-y-9 justify-center items-end px-4 pb-12 sm:pb-0 sm:px-0 sm:items-center pt-8 xl:pt-0 xl:items-end mb-20 xl:mb-0 bg-mobile xl:bg-desktop bg-white bg-no-repeat bg-cover xl:bg-my">
        <CardFront
